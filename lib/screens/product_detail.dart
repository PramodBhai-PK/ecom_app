              ...
              child: Container(
                child: Padding(
                  ...
                  footer: Padding(
                    ...
                    child: Container(
                      child:ListTile(
                        leading: Text(this.widget.product.name,style:TextStyle(fontSize: 18,fontWeight: FontWeight.bold)),
                        title: Padding(
                          padding: const EdgeInsets.only(top:18.0),
                          child: Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: <Widget>[
                            Expanded(child: Text("${this.widget.product.price - this.widget.product.discount}",style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,fontSize: 20),)),
                            
                            Expanded(child: Text("${this.widget.product.price}",style: TextStyle(color: Colors.red, fontWeight:FontWeight.bold,decoration: TextDecoration.lineThrough))),
                            Padding(
                              padding: const EdgeInsets.only(top:10.0,right: 8),
                              child: Text("save:(${this.widget.product.discount})",style: TextStyle(color: Colors.green, fontStyle: FontStyle.italic,)),
                            ),
                          ],),
                        ),
                      )
                  ...
                  Divider(),
                        ListTile(
                          ...
                          subtitle:Text(this.widget.product.detail, style: TextStyle(fontSize:18),)
                        )
        ]
      ),
    );

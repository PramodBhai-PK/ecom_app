             ...
             Text(this.widget.product.name),
              ...
              Expanded(
                   child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                     children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.only(bottom:5.0,left: 15,right: 5),
                    child: Text('₹:${this.widget.product.price - this.widget.product.discount}',style: TextStyle(fontSize:16,fontWeight: FontWeight.bold),),
                  ),
                  Flexible(
                    child: Padding(
                    padding: const EdgeInsets.only(bottom:5.0,left: 5,right: 10),
                    child: Text('₹:${this.widget.product.price}',style: TextStyle(decoration:TextDecoration.lineThrough,fontSize:16,fontWeight: FontWeight.bold,color: Colors.red),),
                  )),
                ],),
              ),
            ],
